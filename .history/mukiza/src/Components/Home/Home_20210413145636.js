...
const Box = () => {
  ...
  const Para = () => {
    const BoxVariant = {
      visible: { opacity: 1, x: 10, y: 50, transition: { duration: 1 } },
    ...
    return (
      ...
      >
              <div>
                ...
                <p className="p3">A passionate web Developer and software engineer thrilled<br></br> to work on end to end products which simplify people’s lives</p>
                </div>
      </motion.div>
    );
  };
